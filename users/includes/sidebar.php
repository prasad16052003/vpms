        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                    <a href="manage-incomingvehicle.php"> <i class="menu-icon ti-truck"></i>Manage In Vehicle </a>
                    </li>
                    <li>
                    <a href="manage-outgoingvehicle.php"> <i class="menu-icon ti-truck"></i>Manage Out Vehicle </a>
                    </li>
                </ul>
            </div>
        </nav>
